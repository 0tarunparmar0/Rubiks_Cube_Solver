...
// Converts a move index into its string representation
...
// Executes a move on the cube using the given move index
...
// Inverts the given move on the cube
...
// Shuffles the Rubik's Cube randomly a given number of times and returns the moves performed
...
// Returns a string representing the colors of a corner given its index
...
// Returns the index of a corner piece based on its colors
...
// Returns the orientation of a corner piece based on its colors
